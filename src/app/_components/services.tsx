    ...
    <section className="bg-white py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
                ...
                <div key={index} className='flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/3)] px-3'>
                  <article className='bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col'>
                    ...
                    <div className='border-t border-gray-700 pt-4 flex items-center justify-between'>
                      ...
                      <a
                        href={`https://wa.me/5511930413365?text=${encodeURIComponent(`Olá, gostaria de saber mais sobre: ${item.title}. Oferecido pelo Pet Shop Dev.`)}`}
                        target='_blank'
          ...
          <button
            onClick={scrollPrev}
            className=' size-10 bg-white flex items-center justify-center rounded-full shadow-lg absolute left-3 -translate-y-1/2
          ...
          <button
            onClick={scrollNext}
            className=' size-10 bg-white flex items-center justify-center rounded-full shadow-lg absolute -right-6 -translate-y-1/2
            -translate-x-1/2 top-1/2 z-10'
          >
            <ChevronRight
              className='size-6 text-gray-600' />
